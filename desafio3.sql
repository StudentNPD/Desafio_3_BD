...
-- TABLA REPARTO
CREATE TABLE "reparto" ("id_pelicula" SMALLINT,"actor" VARCHAR(30));
...
--  TABLA PELICULA 
CREATE TABLE "peliculas" ("id" SMALLINT,"pelicula" VARCHAR(60),"ano_estreno" SMALLINT,"director" VARCHAR(30));
INSERT INTO "peliculas" ("id","pelicula","ano_estreno","director") VALUES 
...
-- PREGUNTA 3 - Obtener el ID de la película “Titanic”.
SELECT id FROM peliculas WHERE pelicula='Titanic';
-- 2

-- PREGUNTA 4 - Listar a todos los actores que aparecen en la película "Titanic"
SELECT actor
from peliculas 
INNER JOIN reparto 
ON id=id_pelicula
...
-- PREGUNTA 5 - Consultar en cuántas películas del top 100 participa Harrison Ford
...
-- PREGUNTA 6 - Indicar las películas estrenadas entre los años 1990 y 1999 ordenadas por título de mmanera ascendente
SELECT ano_estreno, pelicula
from peliculas
WHERE ano_estreno 
...
-- PREGUNTA 7 - Hacer una consulta SQL que muestre los títulos con su longitud, la longitud debe ser nombrado para la consulta como “longitud_titulo”
SELECT concat(LENGTH(pelicula),'_',pelicula) as longitud_titulo
FROM peliculas;
-- longitud_titulo
-- 11_Forest Gump
-- 7_Titanic
...
-- PREGUNTA 8 - Consultar cual es la longitud más grande entre todos los títulos de las películas
SELECT concat(LENGTH(pelicula),'_',pelicula) as longitud_titulo
FROM peliculas ORDER by LENGTH(pelicula) DESC LIMIT 1;
-- 52_Sweeney Todd: El barbero diabólico de la calle Fleet


-- Disculpe la demora! (esta linea se autodestruira en 4 días)
